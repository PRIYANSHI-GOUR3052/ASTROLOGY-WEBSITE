...
export function Footer() {
  return (
    <footer className="bg-nebula-indigo-dark text-starlight-silver py-12 relative">
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <ul className="space-y-2 text-sm">
              {quickLinks.map((link) => (
                <li key={link.href} className="relative">
                  <Link 
                    href={link.href} 
                    className="hover:text-mystic-lavender transition-colors block w-fit"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="relative">
            ...
            <div className="mt-4 flex justify-start space-x-4">
              <Link href="https://facebook.com" className="text-starlight-silver hover:text-mystic-lavender transition-colors block w-fit">
                <span className="sr-only">Facebook</span>
                <Facebook className="h-6 w-6" />
              </Link>
              <Link href="https://instagram.com" className="text-starlight-silver hover:text-celestial-blue transition-colors block w-fit">
                <span className="sr-only">Instagram</span>
                <Instagram className="h-6 w-6" />
              </Link>
              <Link href="https://twitter.com" className="text-starlight-silver hover:text-cosmic-purple transition-colors block w-fit">
        ...
        <div className="mt-8 pt-8 border-t border-starlight-silver/20 text-center text-sm relative">
