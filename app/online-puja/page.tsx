...
export default function OnlinePujaPage() {
  ...
  return (
    <>
      {/* Prevent horizontal scroll on html/body for all devices */}
      <style>{`html, body { overflow-x: hidden !important; }`}</style>
      <div className="min-h-screen bg-white pt-20 md:pt-32 overflow-x-hidden w-full">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 py-8 w-full overflow-x-hidden">
          {/* Banner Heading */}
          <div className="w-full rounded-3xl bg-gradient-to-r from-[#fdf6f2] via-[#f3e8ff] to-[#e0f2fe] py-8 sm:py-12 px-2 sm:px-4 md:px-16 mb-12 flex flex-col items-center justify-center shadow-md border border-[#f3e8ff] overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8 w-full overflow-x-hidden">
            {/* Main Content */}
            <div className="lg:col-span-2 w-full min-w-0">
              ...
              {/* Tab Content */}
              {activeTab === 'Overview' && (
                <section className="mb-12 text-base sm:text-lg leading-relaxed text-black space-y-6 break-words w-full max-w-full overflow-x-hidden">
                  ...
                  <p className="text-black text-justify break-words max-w-full w-full" style={{ fontFamily: 'Inter, Lato, Open Sans, sans-serif' }}>
              ...
              {activeTab === 'Benefits' && (
                <section className="mb-12 w-full max-w-full overflow-x-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 w-full">
                    {/* Card 1 */}
                    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="rounded-2xl shadow-lg p-4 sm:p-8 border border-indigo-100 flex flex-col gap-4 min-w-0" style={{ background: 'linear-gradient(135deg, #f3e8ff 0%, #e0f2fe 100%)' }}>
                    ...
                    {/* Card 2 */}
                    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }} className="rounded-2xl shadow-lg p-4 sm:p-8 border border-pink-100 flex flex-col gap-4 min-w-0" style={{ background: 'linear-gradient(135deg, #ffe0f0 0%, #fdf6f2 100%)' }}>
                    ...
                    {/* Card 3 */}
                    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="rounded-2xl shadow-lg p-4 sm:p-8 border border-green-100 flex flex-col gap-4 min-w-0" style={{ background: 'linear-gradient(135deg, #e0ffe8 0%, #e0f2fe 100%)' }}>
                    ...
                    {/* Card 4 */}
                    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} viewport={{ once: true }} className="rounded-2xl shadow-lg p-4 sm:p-8 border border-yellow-100 flex flex-col gap-4 min-w-0" style={{ background: 'linear-gradient(135deg, #fffbe0 0%, #f3e8ff 100%)' }}>
                    ...
                    {/* Card 5 */}
                    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1.0 }} viewport={{ once: true }} className="rounded-2xl shadow-lg p-4 sm:p-8 border border-blue-100 flex flex-col gap-4 min-w-0" style={{ background: 'linear-gradient(135deg, #e0f7ff 0%, #f3e8ff 100%)' }}>
                    ...
                    {/* Card 6 */}
                    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1.1 }} viewport={{ once: true }} className="rounded-2xl shadow-lg p-4 sm:p-8 border border-purple-100 flex flex-col gap-4 min-w-0" style={{ background: 'linear-gradient(135deg, #f3e8ff 0%, #e0ffe8 100%)' }}>
              ...
              {activeTab === 'Purchase' && (
                <section className="mb-12 text-base sm:text-lg leading-relaxed text-black space-y-6 w-full max-w-full overflow-x-hidden">
                  ...
                  <div className="flex justify-center w-full max-w-full overflow-x-hidden">
                    <div className="w-full max-w-xl bg-gradient-to-br from-[#f3e8ff] via-[#e0f2fe] to-[#fdf6f2] rounded-3xl shadow-2xl border border-white/60 p-0 overflow-hidden relative min-w-0" style={{ boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.18)', backdropFilter: 'blur(8px)' }}>
                      {/* Dreamy Abstract Illustration */}
                      <div className="w-full h-32 sm:h-44 bg-gradient-to-br from-[#e0e7ff] via-[#f3e8ff] to-[#fdf6f2] flex items-center justify-center overflow-x-hidden">
                        <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style={{ maxWidth: '100px', maxHeight: '100px', width: '100%', height: '100%' }}>
                      ...
                      <div className="p-4 sm:p-8 flex flex-col items-center gap-6 w-full max-w-full overflow-x-hidden">
              ...
              {activeTab === 'About' && (
                <section className="mb-12 w-full max-w-full overflow-x-hidden">
                  ...
                  <div className="bg-white shadow-md p-4 sm:p-8 rounded-2xl border border-neutral-200 mb-12 w-full max-w-full overflow-x-hidden">
            ...
            {/* Sidebar */}
            <div className="lg:col-span-1 flex flex-col gap-8 w-full max-w-full overflow-x-hidden min-w-0">
              <AboutSummary />
            </div>
          </div>
        </div>
