...
const faqs = [
  {
    q: 'What distinguishes the sidereal zodiac used in Vedic astrology from the tropical zodiac of Western astrology?',
    a: "The sidereal zodiac, foundational to Vedic astrology, aligns with the actual constellations and accounts for the precession of the equinoxes, whereas the tropical zodiac used in Western astrology is seasonally fixed and does not reflect the current positions of the constellations."
  },
  {
    q: 'How do planetary periods (Dashas) influence predictive accuracy in Vedic astrology?',
    a: "Dashas are unique to Vedic astrology and provide a sophisticated timeline of planetary influences throughout an individual's life. By analyzing these periods, astrologers can offer remarkably precise predictions regarding major life events and transitions."
  },
  {
    q: 'What is the significance of the Moon sign (Rashi) in Vedic astrology?',
    a: "The Moon sign is considered paramount in Vedic astrology as it governs the mind, emotions, and subconscious patterns. Many predictive techniques, including the calculation of planetary periods and transits, are based on the Moon sign rather than the Sun sign."
  },
  {
