...
import TaurusInfoNavigation from '../../../components/TaurusInfoNavigation';
import TaurusProductRecommendations from '../../../components/TaurusProductRecommendations';
    ...
    <>
      ...
      >
        ...
        <style jsx global>{`
          ...
          /* Custom scrollbar for Taurus theme */
          ::-webkit-scrollbar {
            width: 8px;
          }
