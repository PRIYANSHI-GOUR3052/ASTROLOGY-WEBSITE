...
import SagittariusInfoNavigation from '../../../components/SagittariusInfoNavigation';
import SagittariusProductRecommendations from '../../../components/SagittariusProductRecommendations';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto p-8 pt-12">
        <SagittariusProductRecommendations />
      </div>
    </motion.div>
...
<div className="-mt-8">
  <SimpleHorizontalBanner />
        ...
        >
          <div className="flex justify-between items-center">
            <button className="flex flex-col items-center py-2 px-4 text-orange-800">
              ...
              <span className="text-xs font-medium font-serif">Sagittarius</span>
            </button>
        ...
        <style jsx global>{`
          ...
          /* Custom scrollbar for warm Sagittarius theme */
          ::-webkit-scrollbar {
            width: 10px;
          }
