...
import LeoInfoNavigation from '../../../components/LeoInfoNavigation';
import LeoProductRecommendations from '../../../components/LeoProductRecommendations';
...
<div className="-mt-8">
  <SimpleHorizontalBanner />
        ...
        >
          <div className="flex justify-between items-center">
            <button className="flex flex-col items-center py-2 px-4 text-orange-800">
              ...
              <span className="text-xs font-medium font-serif">Leo</span>
            </button>
        ...
        <style jsx global>{`
          ...
          /* Custom scrollbar for warm Leo theme */
          ::-webkit-scrollbar {
            width: 10px;
          }
