...
import CapricornInfoNavigation from '../../../components/CapricornInfoNavigation';
import CapricornProductRecommendations from '../../../components/CapricornProductRecommendations';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto p-8 pt-12">
        <CapricornProductRecommendations />
      </div>
    </motion.div>
        ...
        >
          <div className="flex justify-between items-center">
            <button className="flex flex-col items-center py-2 px-4 text-orange-800">
              ...
              <span className="text-xs font-medium font-serif">Capricorn</span>
            </button>
