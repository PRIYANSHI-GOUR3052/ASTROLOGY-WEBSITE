...
import { FaUser, FaCompass, FaHeart, FaShieldAlt, FaCalendarAlt, FaHeartbeat, FaInfinity, FaPrayingHands, FaStar, FaQuestionCircle, FaBookOpen, FaUserCheck, FaClock, FaRocket, FaHandHoldingHeart, FaBalanceScale, FaChild, FaBrain, FaSeedling } from 'react-icons/fa';
...
const faqs = [
  ...
  {
    q: 'What is a "Birth Star" or "Janma Nakshatra"?',
  ...
  {
    q: 'Can a Nakshatra be \'bad\' or \'unlucky\'?',
    a: 'No Nakshatra is inherently \'bad.\' Vedic astrology views each one as a unique field of cosmic energy with its own strengths and challenges. Some Nakshatras, like Mula (ruled by the goddess of destruction, Nirriti), are termed \'gandanta\' or \'fierce\' and can present more intense life lessons. However, these same Nakshatras often bestow immense resilience, profound spiritual insight, and the power to overcome great obstacles. The key is to understand and consciously work with the energy, not to fear it.'
  },
  {
...
export default function NakshatraSecretsPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-white via-indigo-50 to-white font-sans pt-16 md:pt-24">
      <div className="container mx-auto pb-16 px-4 relative z-10">
        ...
        {activeTab === 'Overview' && (
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="mb-12 text-lg leading-relaxed text-gray-800 space-y-6" style={{ fontFamily: 'Lora, serif', textAlign: 'justify' }}>
            ...
            <p>The practical application of Nakshatras shines brightest in the field of electional astrology, or <span className="font-bold">Muhurta</span>. Choosing the right Nakshatra for an event is paramount to its success. Some Nakshatras are classified as 'fierce' (Ugra) and are ideal for competitive or destructive actions, while others are 'gentle' (Mridu) and perfectly suited for artistic pursuits or romantic occasions. By aligning your actions with the cosmic energy of the prevailing Nakshatra, you can harness the universal flow to support your endeavors.</p>
            ...
            <p>For daily planning, Vedic astrology employs the concept of <span className="font-bold">Tarabala</span>, or "stellar strength." This calculates the strength of any given day by counting the position of the transiting Moon's Nakshatra from your own birth Nakshatra. The resulting number indicates whether the day is favorable (like Sampat, wealth-giving) or unfavorable (like Vipat, dangerous) for your activities, providing a personalized daily guide to success.</p>
            ...
            <p>While there are 27 primary Nakshatras, ancient texts speak of a 28th, intercalary Nakshatra known as <span className="font-bold">Abhijit</span>. Located between Uttara Ashadha and Shravana, it is considered a powerful, "victorious" constellation associated with Lord Brahma. Though not used for natal analysis, it is highly prized in Muhurta for ensuring success in critical undertakings, acting as a divine wild card to overcome obstacles.</p>
