      ...
      <Link href={`/astrologer/${a.id}`} className="block">
        <div className="bg-white rounded-xl shadow-sm p-5 flex flex-col gap-2 cursor-pointer h-full border border-transparent transition-all max-w-md mx-auto" style={{ fontFamily: 'Poppins, Inter, Montserrat, Arial, sans-serif' }}>
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            {a.orders > 0 && <span className="text-xs font-bold text-yellow-700 bg-yellow-100 px-2 py-0.5 rounded shadow-sm">{a.orders} orders</span>}
            <span className="text-base text-gray-700 ml-auto font-bold">₹ {a.price}/min</span>
            <Link href="/contact" className="ml-4">
              <button className="border-2 border-green-500 text-green-600 font-bold py-2 px-6 rounded-lg hover:bg-green-50 transition min-w-fit" style={{ fontFamily: 'Poppins, Inter, Montserrat, Arial, sans-serif' }}>Chat</button>
            </Link>
          </div>
        </div>
      </Link>
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-[#23244a] bg-[#ffe066] px-6 py-3 rounded-lg shadow inline-block" style={{ fontFamily: 'Playfair Display, Poppins, Inter, Montserrat, Arial, sans-serif', letterSpacing: '0.01em' }}>Talk to Best Astrologers</h1>
        <div className="flex items-center gap-4 flex-wrap">
          <span className="text-gray-700 font-medium" style={{ fontFamily: 'Poppins, Inter, Montserrat, Arial, sans-serif' }}>Available balance: <span className="font-bold">₹ 0</span></span>
          <button className="bg-green-500 text-white px-4 py-2 rounded font-bold shadow hover:bg-green-600 transition" style={{ fontFamily: 'Poppins, Inter, Montserrat, Arial, sans-serif' }}>Recharge</button>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-4 mb-6 items-center">
        ...
        {/* Sort By */}
        <div className="flex gap-2 items-center w-full md:w-auto">
          <span className="text-gray-700 font-medium" style={{ fontFamily: 'Poppins, Inter, Montserrat, Arial, sans-serif' }}>Sort by:</span>
