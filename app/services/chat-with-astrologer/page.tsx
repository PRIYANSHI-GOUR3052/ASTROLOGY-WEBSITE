...
import { MessageSquare, Star, Zap, Shield, ChevronDown, Clock, DollarSign, ClipboardList, BrainCircuit, Users, CalendarCheck, TrendingUp, Sun, Moon, Heart } from 'lucide-react';
      ...
      <div className="container mx-auto pt-8 px-4 pb-16 relative z-10">
        ...
        {activeTab === 'Overview' && (
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="mb-12 text-lg leading-relaxed text-gray-700 space-y-6 font-sans" style={{ fontFamily: 'Open Sans, Arial, sans-serif', textAlign: 'justify' }}>
            ...
            <p>Chat is an excellent medium for understanding remedial measures. If an astrologer has recommended a specific mantra, gemstone, or practice, you can use the chat service to ask clarifying questions as they arise. "Is it better to start this chant on a Friday or a Sunday?" or "I feel restless after wearing this gemstone, is this normal?" These quick, practical questions can be answered immediately, ensuring your remedial efforts are effective and correctly applied.</p>
                ...
                <div className="max-w-3xl mx-auto">
                    <ol className="space-y-8 relative border-l-2 border-indigo-200">
                        ...
                        <li className="ml-6">
                            ...
                            <p className="text-gray-600">Click the "Chat" button to instantly connect and begin your live consultation. Provide your birth details if needed and ask your questions.</p>
                        </li>
                    </ol>
                </div>
            </section>
