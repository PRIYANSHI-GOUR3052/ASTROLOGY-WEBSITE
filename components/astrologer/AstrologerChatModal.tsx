  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="relative bg-white dark:bg-black rounded-lg shadow-lg w-[350px] sm:w-[400px] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2 bg-gray-50 dark:bg-midnight-black-light" style={{ minHeight: 200, maxHeight: 300 }}>
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700 flex gap-2">
          <input
            type="text"
            className="flex-1 px-3 py-2 rounded border focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-midnight-black-light dark:text-white"
